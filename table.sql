-- MySQL dump 9.11
--
-- Host: localhost    Database: lastanope
-- ------------------------------------------------------
...
CREATE TABLE anope_cs_info (
  ...
  entry_message2 text NOT NULL,
  entry_message3 text NOT NULL,
  entry_message4 text NOT NULL,
  entry_message5 text NOT NULL,
...
--
-- Table structure for table `anope_history`
--
