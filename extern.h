 ...
 * 
 * $Id: extern.h 22 2004-04-01 20:18:50Z rob $ 
 *
 */
...
E void cs_init(void);
E void chanserv(User *u, char *buf,char* buf2);
...
E void cs_join(ChannelInfo *ci);
E void cs_part(ChannelInfo *ci);
